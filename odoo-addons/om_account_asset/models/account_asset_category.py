...
class AccountAssetCategory(models.Model):
    ...
    method_number = fields.Integer(string="Nombre d'année d'amortissement", default=5, help="The number of depreciations needed to depreciate your asset")
    method_period_sel = fields.Selection([('year', 'Année'), ('month', 'Mois')], string='Une entrée chaque', required=True, default='year')
    method_period = fields.Integer(string='Period Length', default=1, help="State here the time between 2 depreciations, in months", compute="_get_number_period")
    ...
    multiple_assets_per_line = fields.Boolean(string='Plusieurs actifs par ligne', default=True,
        help="Plusieurs Immobilisation seront générés en fonction de la quantité de la ligne de facture au lieu d'un actif global.")
